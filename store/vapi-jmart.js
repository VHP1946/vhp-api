...
export class JMart extends Core{
  ...
  GETjapitest(){
    return new Promise((res,rej)=>{
        ...
        return res(this.SENDrequest({pack:wopull,route:'STORE',request:'jmart'}).then(
          answr=>{
            console.log(answr)
          }));
    });
  ...
  GETflbook(book='RES',table='flatratebook'){
      return new Promise((res,rej)=>{
          let opts = {
              table:table,
              bookcode:book
  ...
  GETscontract(custcode,table='contracttable'){
  ...
  GETcustomer(custcode,table='customertable'){
    return new Promise((res,rej)=>{
        let opts = {
            table:table,
            custcode:custcode
  ...
  GETserviceitems(custcode,table='custserviceitems'){
    return new Promise((res,rej)=>{
        let opts = {
            table:table,
            custcode:custcode
